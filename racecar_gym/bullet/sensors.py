...
from racecar_gym.bullet import simulation
from racecar_gym.bullet.simulation import SimulationHandle
from racecar_gym.models.definitions import Observation
from racecar_gym.models.sensors import Sensor


class SimulatedSensor(Sensor[Observation]):
    def __init__(self, handle: SimulationHandle):
        self._handle = handle


class Lidar(SimulatedSensor[np.ndarray]):
